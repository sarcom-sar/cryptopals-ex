...
def test_repeating_key_xor():
    assert set1.repeating_key_xor("I love cryptopals", "ICE") ==\
           "0063292635206920373033312633242530"
    assert set1.repeating_key_xor("Burning 'em, if you ain't quick and nimble\nI go crazy when I hear a cymbal",
                                  "ICE") ==\
